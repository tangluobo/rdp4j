...
import com.tangluobo.rdp4j.io.IOSocket;
import com.tangluobo.rdp4j.io.SocketIO;
import com.tangluobo.rdp4j.layers.ISO;
...
public class RdpTlsFix {
    ...
    public static class RdpTransport extends Transport {
        ...
        @Override
        public com.tangluobo.rdp4j.Packet receivePacket(com.tangluobo.rdp4j.Packet p, int length) throws IOException {
