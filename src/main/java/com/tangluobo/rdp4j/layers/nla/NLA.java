...
import com.tangluobo.rdp4j.jasn1.ber.BerInputStream;
...
import com.tangluobo.rdp4j.HexDump;
import com.tangluobo.rdp4j.Packet;
import com.tangluobo.rdp4j.RdesktopCryptoException;
import com.tangluobo.rdp4j.State;
import com.tangluobo.rdp4j.CredSspTokenMode;
import com.tangluobo.rdp4j.layers.Transport;
...
public class NLA {
	...
	class TSPasswordCreds implements TSCredentialType {
		...
		public BerType write() throws IOException {
			return new BerSequence(
					new com.tangluobo.rdp4j.jasn1.ber.types.BerContextSpecific(
	...
	class TSCredentials implements BerPayload {
		...
		public BerType write() throws IOException {
			...
			return new BerSequence(
					new com.tangluobo.rdp4j.jasn1.ber.types.BerContextSpecific(new BerInteger(credType), 0),
					new com.tangluobo.rdp4j.jasn1.ber.types.BerContextSpecific(
	...
	public void start() throws IOException, RdesktopCryptoException {
		...
		java.util.List<String> creds = state.getCredentialProvider().getCredentials("nla", 0,
				com.tangluobo.rdp4j.CredentialProvider.CredentialType.DOMAIN,
				com.tangluobo.rdp4j.CredentialProvider.CredentialType.USERNAME,
				com.tangluobo.rdp4j.CredentialProvider.CredentialType.PASSWORD);
