...
import com.tangluobo.rdp4j.jasn1.ber.internal.Util;
import com.tangluobo.rdp4j.jasn1.util.HexConverter;
...
public class BerOctetString implements Serializable, BerType {
    ...
    public BerOctetString(String value) {
    	this(value.getBytes());
    }
    
    public BerOctetString(char[] value) {
    	this(new String(value).getBytes());
    }
