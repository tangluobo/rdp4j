...
import com.tangluobo.rdp4j.layers.nla.HResultException;
...
public class RdpClient {
    ...
    public void connect(String host, int port, String username, String password,
        ...
        options.getSecurityTypes().add(com.tangluobo.rdp4j.SecurityType.STANDARD);
        if (useSsl) {
            options.getSecurityTypes().add(com.tangluobo.rdp4j.SecurityType.SSL);
            options.getSecurityTypes().add(com.tangluobo.rdp4j.SecurityType.HYBRID);
        }
        ...
        if (RdpPatch.isDiagnosticsEnabled()) {
            ...
            diagTimer.scheduleAtFixedRate(new java.util.TimerTask() {
                ...
                public void run() {
                    ...
                    if (rdpLayer instanceof RdpPatch patch) {
