...
public class RdesktopDisconnectException extends RdesktopException {
	...
	public RdesktopDisconnectException(int reason) {
		super(textDisconnectReason(reason));
		this.reason = reason;
	}

	public RdesktopDisconnectException(int reason, Throwable cause) {
		super(textDisconnectReason(reason), cause);
		this.reason = reason;
	}
