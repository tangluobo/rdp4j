...
import com.tangluobo.rdp4j.OrderException;
import com.tangluobo.rdp4j.RdesktopDisconnectException;
...
public class RdpPatch extends Rdp {
    ...
    public RdpPatch(IContext context, State state, VChannels channels) {
        ...
        try {
            ...
            pm = Rdp.class.getDeclaredMethod("processPacket", int[].class, com.tangluobo.rdp4j.Packet.class);
    ...
    @Override
    public void rdp5_process(com.tangluobo.rdp4j.Packet s, boolean encryption, boolean shortform)
    ...
    @Override
    public void rdp5_process(com.tangluobo.rdp4j.Packet s, boolean e)
            throws RdesktopException, OrderException {
        rdp5_process(s, e, false);
    }

    @Override
    protected void processBitmapUpdates(com.tangluobo.rdp4j.Packet data) throws RdesktopException {
    ...
    public void mainLoop() throws IOException, RdesktopException {
        ...
        try {
        int[] type = new int[1];
        com.tangluobo.rdp4j.Packet data;
        while (true) {
            // 调用private receive()
            data = null;
            if (DIAGNOSTICS_ENABLED) {
            ...
            if (DIAGNOSTICS_ENABLED) try {
                if (streamField != null && nextPacketField != null) {
                    ...
                    if (stream != null) {
                        com.tangluobo.rdp4j.Packet p = (com.tangluobo.rdp4j.Packet) stream;
